...
export default function Page() {
  useEffect(() => {
    ...
    instance.track("newsletter_signup_submitted", { placement: "inline" });
  }, []);

  return (
    <>
      <PageViewGroupNav group="no-pageview-anywhere" currentPage={2} totalPages={4} />
      <main className="page">
        <h1>Page Views — No Page View Anywhere — Page 2</h1>
