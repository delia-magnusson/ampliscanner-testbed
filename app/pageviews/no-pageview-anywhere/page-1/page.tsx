...
export default function Page() {
  useEffect(() => {
    ...
    instance.track("faq_expanded", { question_id: "billing-cycle" });
  }, []);

  return (
    <>
      <PageViewGroupNav group="no-pageview-anywhere" currentPage={1} totalPages={4} />
      <main className="page">
        <h1>Page Views — No Page View Anywhere — Page 1</h1>
