...
export default function Page() {
  ...
  return (
    <>
      <PageViewGroupNav group="proliferation-low" currentPage={3} totalPages={4} />
      <main className="page">
        <h1>Page Views — Proliferation (Low) — Page 3</h1>
        <p>Fires the standard page-view event correctly.</p>
      </main>
    </>
  );
}
